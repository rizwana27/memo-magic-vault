...
const TopNavLayout: React.FC<TopNavLayoutProps> = ({ children, activeTab, onTabChange }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black">
      {/* Top Navigation Bar */}
      <nav className="bg-gray-800/95 backdrop-blur-sm border-b border-gray-700/50 shadow-xl sticky top-0 z-50">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-3 px-3 py-2 rounded-lg bg-gray-700/50 hover:bg-gray-700 transition-all duration-200 border border-gray-600/50"
                >
                ...
                {userMenuOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-xl border border-gray-700 py-2 z-50">
                    ...
                    <button
                      ...
                      className="w-full flex items-center space-x-2 px-4 py-2 text-left text-red-400 hover:bg-red-600/10 hover:text-red-300 transition-colors"
                    >
