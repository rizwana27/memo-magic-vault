...
export const useBulkCreateTimesheets = () => {
  ...
  return useMutation({
    mutationFn: async (timesheetData: Array<{
      ...
      // Prepare timesheet data without hours (let database calculate) and without timesheet_id (auto-generated)
      const timesheetsToInsert = timesheetData.map(entry => ({
        ...
        notes: entry.notes,
        // Note: timesheet_id and hours will be auto-generated by database triggers
      }));
